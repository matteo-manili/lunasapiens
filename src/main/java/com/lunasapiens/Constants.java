...
public class Constants {
    ...
    public static final String LIMITATORE_MESS_BOT_IA_CACHE_USER = "rateLimiterCacheUser";
    public static final String LIMITATORE_MESS_BOT_IA_CACHE_UTENTE = "rateLimiterCacheUtente";
