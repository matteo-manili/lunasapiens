...
public class GeneratorVideo {
    ...
    public static byte[] createVideoFromImages(String inputImagePath, String nomeFileVideo) {
        ...
        final int width = 700; final int height = 400; final int durataSecondiImmagine = 5;
        ...
        try {
            ...
            recorder.setVideoCodec( avcodec.AV_CODEC_ID_H264 ); //avcodec.AV_CODEC_ID_H264 //avcodec.AV_CODEC_ID_MPEG4 // avcodec.AV_CODEC_ID_H264 // Imposta il codec video su MPEG4
