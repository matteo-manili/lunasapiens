...
public class Aspetti {
    ...
    private String nomePianeta_1;
    private int numeroPianeta_1;

    private String nomePianeta_2;
    private int numeroPianeta_2;

    private int tipoAspetto;
    private String significatoAspetto;


    public Aspetti(int numeroPianeta_1, String nomePianeta_1, int numeroPianeta_2, String nomePianeta_2, int tipoAspetto, String significatoAspetto) {
        this.numeroPianeta_1 = numeroPianeta_1;
        this.nomePianeta_1 = nomePianeta_1;
        this.numeroPianeta_2 = numeroPianeta_2;
    ...
    public String getNomePianeta_1() {
        return nomePianeta_1;
    }

    public int getNumeroPianeta_1() {
        return numeroPianeta_1;
    }

    public String getNomePianeta_2() {
        return nomePianeta_2;
    }

    public int getNumeroPianeta_2() {
        return numeroPianeta_2;
    }

    public int getTipoAspetto() {
        return tipoAspetto;
    }

    public String getSignificatoAspetto() {
        return significatoAspetto;
    }
}
