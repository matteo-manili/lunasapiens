...
public class TransitiPianeti {

    private static final Logger logger = LoggerFactory.getLogger(TransitiPianeti.class);
    ...
    public TransitiPianeti() { }

    public TransitiPianeti(ArrayList<PianetaPosizTransito> pianeti) {
