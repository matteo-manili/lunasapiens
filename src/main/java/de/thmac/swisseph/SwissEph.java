...
public class SwissEph implements Serializable {
	 ...
	 * @see SweConst#SE_EPHE_PATH
	 * @see SwissEph#swe_set_ephe_path(String)
	 */
	 ...
	 * @see #swe_calc_ut(double, int, int, double[], StringBuffer)
	 * @see #swe_fixstar_ut(StringBuffer, double, int, double[],
	 *      StringBuffer)
	 * @see #swe_fixstar(StringBuffer, double, int, double[],
	 *      StringBuffer)
	 */
	...
	FilePtr swi_fopen(int ifno, String fname, String ephepath, StringBuffer serr) throws SwissephException {
		...
		for (i = 0; i < np; i++) {
			...
			fnamp = s;
			try {
				fp = new RandomAccessFile(fnamp, SwissData.BFILE_R_ACCESS);
				// In Java only????:
				if (ifno >= 0) {
	 ...
	 * @see SwissEph#getFixstarMagnitude(StringBuffer)
	 */
	 ...
	 * @return magnitude of the star.
	 * @see SwissEph#getFixstarMagnitude(String)
	 */
...
class MeffEle implements Serializable {
	double r;
	double m;
