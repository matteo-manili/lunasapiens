...
public class TCPlanetPlanet extends TransitCalculator implements java.io.Serializable {
	 ...
	 * @see TCPlanet#TCPlanet(SwissEph, int, int, double, int,
	 *      double)
	 * @see SweConst#SEFLG_TRANSIT_LONGITUDE
	 * @see SweConst#SEFLG_TRANSIT_LATITUDE
	 * @see SweConst#SEFLG_TRANSIT_DISTANCE
	 * @see SweConst#SEFLG_TRANSIT_SPEED
	 * @see SweConst#SE_AST_OFFSET
	 * @see SweConst#SEFLG_PARTILE_TRANSIT
	 * @see SweConst#SEFLG_PARTILE_TRANSIT_START
	 * @see SweConst#SEFLG_PARTILE_TRANSIT_END
	 * @see SweConst#SEFLG_YOGA_TRANSIT
	 * @see SweConst#SEFLG_TOPOCTR
	 * @see SweConst#SEFLG_EQUATORIAL
