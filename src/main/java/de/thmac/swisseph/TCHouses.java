...
public class TCHouses extends TransitCalculator implements java.io.Serializable {
	 ...
	 * @see TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int,
	 *      int, double)
	 * @see TCPlanet#TCPlanet(SwissEph, int, int, double)
	 * @see SweConst#SEFLG_TRANSIT_LONGITUDE
	 * @see SweConst#SEFLG_SIDEREAL
	 * @see SweConst#SE_HOUSE1
	 * @see SweConst#SE_HOUSE2
	 * @see SweConst#SE_HOUSE3
	 * @see SweConst#SE_HOUSE4
	 * @see SweConst#SE_HOUSE5
	 * @see SweConst#SE_HOUSE6
	 * @see SweConst#SE_HOUSE7
	 * @see SweConst#SE_HOUSE8
	 * @see SweConst#SE_HOUSE9
	 ...
	 * @see SweConst#SE_HSYS_PLACIDUS
	 * @see SweConst#SE_HSYS_KOCH
	 * @see SweConst#SE_HSYS_PORPHYRIUS
	 * @see SweConst#SE_HSYS_REGIOMONTANUS
	 * @see SweConst#SE_HSYS_CAMPANUS
	 * @see SweConst#SE_HSYS_EQUAL
	 * @see SweConst#SE_HSYS_VEHLOW
	 * @see SweConst#SE_HSYS_MERIDIAN
	 * @see SweConst#SE_HSYS_HORIZONTAL
	 * @see SweConst#SE_HSYS_POLICH_PAGE
	 * @see SweConst#SE_HSYS_ALCABITIUS // * @see
	 *      swisseph.SweConst#SE_HSYS_GAUQUELIN_SECTORS
	 * @see SweConst#SE_HSYS_MORINUS
	 * @see SweConst#SE_HSYS_KRUSINSKI
	 * @see SweConst#SE_HSYS_WHOLE_SIGN
	 */
