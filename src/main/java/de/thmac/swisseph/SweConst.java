...
public class SweConst implements java.io.Serializable {
	 ...
	 * 
	 * @see SwissEph#swe_rise_trans(double, int,
	 *      StringBuffer, int, int, double[], double, double,
	 *      DblObj, StringBuffer)
	 */
	 ...
	 * 
	 * @see SwissEph#swe_azalt(double, int, double[], double,
	 ...
	 * 
	 * @see SwissEph#swe_azalt_rev(double, int, double[],
	 *      double[], double[])
	 */
